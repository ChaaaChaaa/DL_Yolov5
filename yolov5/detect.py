...
Usage:
    $ python path/to/detect.py --source ../datasets/coo128/val2017/img.jpg --weights yolov5s.pt --img 640


python yolov5/detect.py --source datasets/coco128/images/val2017/IMG_2395_jpeg_jpg.rf.9f1503ad3b7a7c7938daed057cc4e9bc.jpg --weights yolov5s.pt --img 640
